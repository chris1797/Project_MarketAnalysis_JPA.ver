...
<body>
	...
	<main>
		...
		<section class="py-5 text-center container">
			<div class="row py-lg-5">
				<div class="col-lg-6 col-md-8 mx-auto">
					<h1 class="fw-light">서울시 상권현황의 상권그래프</h1>
					<p class="lead text-muted">그래프 및 지도 들어갈곳</p>
				</div>
			</div>
		</section>
		...
		<section class="py-5 text-center container">
			<div class="row py-lg-5">
				<div class="col-lg-6 col-md-8 mx-auto">
					<a id="menu" href="#">지역별상권현황(지도)</a><br> <a id="menu"
						href="/board/main">커뮤니티</a><br> <a id="menu" href="#">서울시
						현황데이터 </a><br>
				</div>
			</div>
		</section>
	...
	<footer class="text-muted py-5">
		<div class="container">
			...
			<p class="mb-1">Album example is &copy; Bootstrap, but please
				download and customize it for y ourself!</p>
			<p class="mb-0">
